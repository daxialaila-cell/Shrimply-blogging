class AlgoliaSearch {
    ...
    createPaginationWidget() {
        return instantsearch.widgets.pagination({
            ...
            showFirstLast: false,
            templates: {
                first: '<i class="Shrimply fas fa-angles-left"></i>',
                last: '<i class="Shrimply fas fa-angles-right"></i>',
                previous: '<i class="Shrimply fas fa-angle-left"></i>',
                next: '<i class="Shrimply fas fa-angle-right"></i>',
            },
            cssClasses: {
                root: "pagination",
