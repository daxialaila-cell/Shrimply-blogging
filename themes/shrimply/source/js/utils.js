...
Shrimply.utils = {
  ...
  waitElementVisible: function(selectorOrElement, callback, offsetFactor) {
    ...
    function waitInViewport(element) {
      Shrimply.utils.listenDOMLoaded(function() {
        if (Shrimply.utils.elementVisible(element, offsetFactor)) {
          callback();
          return;
        }
        if ('IntersectionObserver' in window) {
          ...
          var wrapper = Shrimply.utils.listenScroll(function() {
            if (Shrimply.utils.elementVisible(element, offsetFactor)) {
              Shrimply.utils.unlistenScroll(wrapper);
              callback();
            }
          });
        }
  ...
  loadComments: function(selector, loadFunc) {
    ...
    if (ele) {
      ...
      Shrimply.utils.waitElementVisible(selector, callback, CONFIG.lazyload.offset_factor);
    } else {
      loadFunc();
    }
  },
