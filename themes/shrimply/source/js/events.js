...
Shrimply.events = {
  ...
  registerNavbarEvent: function() {
    ...
    Shrimply.utils.listenScroll(function() {
  ...
  registerParallaxEvent: function() {
    ...
    Shrimply.utils.listenScroll(parallax);
  },
  ...
  registerScrollDownArrowEvent: function() {
    ...
    scrollbar.on('click', function() {
      Shrimply.utils.scrollToElement('#board', -jQuery('#navbar').height());
    });
  },
  ...
  registerRefreshCallback: function(callback) {
    if (!Array.isArray(Shrimply.events._refreshCallbacks)) {
      Shrimply.events._refreshCallbacks = [];
    }
    Shrimply.events._refreshCallbacks.push(callback);
  },

  refresh: function() {
    if (Array.isArray(Shrimply.events._refreshCallbacks)) {
      for (var callback of Shrimply.events._refreshCallbacks) {
...
|                                               |
|            Powered by Hexo x Shrimply            |
| https://github.com/daxialaila-cell/hexo-theme-fluid |
|                                               |
-------------------------------------------------
    `);
  }
