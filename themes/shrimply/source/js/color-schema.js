...
(function(window, document) {
  ...
  var colorSchemaStorageKey = 'Shrimply_Color_Scheme';
  ...
  function setButtonIcon(schema) {
    if (validColorSchemaKeys[schema]) {
      ...
      if (iconElement) {
        ...
        Shrimply.utils.waitElementLoaded(colorToggleIconSelector, function() {
          var iconElement = document.querySelector(colorToggleIconSelector);
          if (iconElement) {
            iconElement.setAttribute('class', 'iconfont ' + icon);
            iconElement.setAttribute('data', invertColorSchemaObj[schema]);
  ...
  function setHighlightCSS(schema) {
    ...
    setTimeout(function() {
      ...
      document.querySelectorAll('.markdown-body pre').forEach((pre) => {
        var cls = Shrimply.utils.getBackgroundLightness(pre) >= 0 ? 'code-widget-light' : 'code-widget-dark';
  ...
  Shrimply.utils.waitElementLoaded(iframeSelector, function() {
    applyCustomColorSchemaSettings();
  });
